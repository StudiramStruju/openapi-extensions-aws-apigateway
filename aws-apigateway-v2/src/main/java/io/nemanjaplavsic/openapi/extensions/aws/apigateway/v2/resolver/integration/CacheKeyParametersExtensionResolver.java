...
@Component
public class CacheKeyParametersExtensionResolver implements ApiGatewayPropertyExtensionResolver {

  private final ApiGatewayServiceProperties properties;

  public CacheKeyParametersExtensionResolver(OpenApiProperties properties) {
